...
context = (
    "IMathAS5 knowledge contract: Read `context/active_qt.toml` first to find which qt-{id} is active. "
    ...
    "then fetch XML content on demand. `context/active_qt.md` is deprecated compatibility only. `RULES.md` is supplemental reference, not an auto-loaded runtime policy."
)
