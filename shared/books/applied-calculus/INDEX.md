...
| File | Section | Title | Exercises |
|------|---------|-------|-----------|
| `ch02_unit_01.xml` | 2.1 | Functions and Their Graphs | Ex. 1–98 |
| `ch02_unit_02.xml` | 2.2 | The Algebra of Functions | Ex. 1–78 |
| `ch02_unit_03.xml` | 2.3 | Functions and Mathematical Models | Ex. 1–88 |
| `ch02_unit_04.xml` | 2.4 | Limits | Ex. 1–98 |
| `ch02_unit_05.xml` | 2.5 | One-Sided Limits and Continuity | Ex. 1–102 |
| `ch02_unit_06.xml` | 2.6 | The Derivative | Ex. 1–62 |
...
| File | Section | Title | Exercises |
|------|---------|-------|-----------|
| `ch05_unit_01.xml` | 5.1 | Exponential Functions | Ex. 1–54 |
| `ch05_unit_02.xml` | 5.2 | Logarithmic Functions | Ex. 1–68 |
| `ch05_unit_03.xml` | 5.3 | Compound Interest | Ex. 1–64 |
| `ch05_unit_04.xml` | 5.4 | Differentiation of Exponential Functions | Ex. 1–92 |
| `ch05_unit_05.xml` | 5.5 | Differentiation of Logarithmic Functions | Ex. 1–100 |
| `ch05_unit_06.xml` | 5.6 | Exponential Functions as Mathematical Models | Ex. 1–38 |
...
| File | Section | Title | Exercises |
|------|---------|-------|-----------|
| `ch09_unit_01.xml` | 9.1 | Differential Equations | Ex. 1–32 |
| `ch09_unit_02.xml` | 9.2 | Separation of Variables | Ex. 1–42 |
| `ch09_unit_03.xml` | 9.3 | Applications of Separable Differential Equations | Ex. 1–32 |
| `ch09_unit_04.xml` | 9.4 | Approximate Solutions of Differential Equations | Ex. 1–16 |
...
| File | Section | Title | Exercises |
|------|---------|-------|-----------|
| `ch12_unit_01.xml` | 12.1 | Measurement of Angles | Ex. 1–30 |
| `ch12_unit_02.xml` | 12.2 | The Trigonometric Functions and Their Graphs | Ex. 1–58 |
| `ch12_unit_03.xml` | 12.3 | Differentiation of Trigonometric Functions | Ex. 1–76 |
| `ch12_unit_04.xml` | 12.4 | Integration of Trigonometric Functions | Ex. 1–58 |
